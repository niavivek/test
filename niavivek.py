...
def f06(string1, string2):
    ...
    if len_diff > 0:
        print("{} is longer than {} by {} chars".format(repr(string1),repr(string2),len_diff))
        print("{} has only {}% the number of chars of {}".format(repr(string2),round(len(string2)/len(string1),2),repr(string1)))
    else:
        print("{} is longer than {} by {} chars".format(repr(string2),repr(string1),-len_diff))
        print("{} has only {}% the number of chars of {}".format(repr(string1),round(len(string1)*100/len(string2),2),repr(string2)))
...
###############################################################################
def f09():
    values = [i for i in range(1,500) if (i % 3 == 0) or (i % 5 == 0)]
    return sum(values)
